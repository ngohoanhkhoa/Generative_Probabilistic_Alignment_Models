...
tf.app.flags.DEFINE_string('data', None, 'Data for training')
tf.app.flags.DEFINE_string('model_dir','../../models/', 'Path to save model')
...
tf.app.flags.DEFINE_float('alpha_KL_divergence_freq', 500, 'KL_divergence anneling')
...
tf.app.flags.DEFINE_integer('latent_variable_number', 50, 'Number of latent variables')
tf.app.flags.DEFINE_float('epsilon_cost_alignment', 3, 'Number of latent variables')

tf.app.flags.DEFINE_string('target_train_data_mono', None , 'Path to target train')
tf.app.flags.DEFINE_string('source_train_data_mono', None , 'Path to target train')
tf.app.flags.DEFINE_integer('source_train_data_mono_use', 0, 'Path to source train')
tf.app.flags.DEFINE_integer('target_train_data_mono_use', 0, 'Path to source train')
tf.app.flags.DEFINE_integer('train_data_bi_use', 1, 'Path to source train')
...
if 'bpe' not in FLAGS.model:
    if FLAGS.data == 'en-ro-toy':
        ...
        tf.app.flags.DEFINE_string('source_valid_data', data_original_dir+'en-ro/corp.test.ro-en.2005.en', 'Path to source validation data')
        tf.app.flags.DEFINE_string('target_valid_data', data_original_dir+'en-ro/corp.test.ro-en.2005.ro', 'Path to target validation data')
    ...
    if FLAGS.data == 'ro-en-toy':
        ...
        tf.app.flags.DEFINE_string('source_valid_data', data_original_dir+'en-ro/corp.test.ro-en.2005.ro', 'Path to source validation data')
        tf.app.flags.DEFINE_string('target_valid_data', data_original_dir+'en-ro/corp.test.ro-en.2005.en', 'Path to target validation data')
        tf.app.flags.DEFINE_string('reference_valid_data', data_original_dir+'en-ro/test.ro-en.2005.ali.startFrom1', 'Path to alignment validation data')
        ...
        tf.app.flags.DEFINE_string('reference_valid_data_f_e', data_original_dir+'en-ro/test.ro-en.2005.ali.startFrom1', 'Path to alignment validation data')
        tf.app.flags.DEFINE_string('reference_valid_data_e_f', data_original_dir+'en-ro/test.en-ro.2005.ali.startFrom1', 'Path to alignment validation data')
    if FLAGS.data == 'en-fr':
    ...
    if FLAGS.data == 'en-vi':
        tf.app.flags.DEFINE_string('source_vocabulary', data_original_dir+'en-vi/train.low.en.pkl', 'Path to source vocabulary')
        tf.app.flags.DEFINE_string('target_vocabulary', data_original_dir+'en-vi/train.low.vi.pkl', 'Path to target vocabulary')
        tf.app.flags.DEFINE_string('source_train_data', data_original_dir+'en-vi/train.low.en.lenSent50', 'Path to source training data')
        tf.app.flags.DEFINE_string('target_train_data', data_original_dir+'en-vi/train.low.vi.lenSent50', 'Path to target training data')
        tf.app.flags.DEFINE_string('source_valid_data', data_original_dir+'en-vi/testing.en-vi.low.en', 'Path to source validation data')
        tf.app.flags.DEFINE_string('target_valid_data', data_original_dir+'en-vi/testing.en-vi.low.vi', 'Path to target validation data')
        tf.app.flags.DEFINE_string('reference_valid_data', data_original_dir+'en-vi/testing.en-vi.align.from1', 'Path to alignment validation data')
        tf.app.flags.DEFINE_string('source_character_vocabulary', data_original_dir+'en-vi/corp.train.de-en.de.low.character.pkl', 'Path to source character vocabulary')
        tf.app.flags.DEFINE_string('target_character_vocabulary', data_original_dir+'en-vi/corp.train.de-en.en.low.character.pkl', 'Path to target character vocabulary')
        tf.app.flags.DEFINE_string('reference_valid_data_e_f', data_original_dir+'en-vi/testing.en-vi.align.from1', 'Path to alignment validation data')
        tf.app.flags.DEFINE_string('reference_valid_data_f_e', data_original_dir+'en-vi/testing.vi-en.align.from1', 'Path to alignment validation data')
    if FLAGS.data == 'vi-en':
        tf.app.flags.DEFINE_string('source_vocabulary', data_original_dir+'en-vi/train.low.vi.pkl', 'Path to source vocabulary')
        tf.app.flags.DEFINE_string('target_vocabulary', data_original_dir+'en-vi/train.low.en.pkl', 'Path to target vocabulary')
        tf.app.flags.DEFINE_string('source_train_data', data_original_dir+'en-vi/train.low.vi.lenSent50', 'Path to source training data')
        tf.app.flags.DEFINE_string('target_train_data', data_original_dir+'en-vi/train.low.en.lenSent50', 'Path to target training data')
        tf.app.flags.DEFINE_string('source_valid_data', data_original_dir+'en-vi/testing.en-vi.low.vi', 'Path to source validation data')
        tf.app.flags.DEFINE_string('target_valid_data', data_original_dir+'en-vi/testing.en-vi.low.en', 'Path to target validation data')
        tf.app.flags.DEFINE_string('reference_valid_data', data_original_dir+'en-vi/testing.vi-en.align.from1', 'Path to alignment validation data')
        tf.app.flags.DEFINE_string('source_character_vocabulary', data_original_dir+'en-vi/corp.train.de-en.de.low.character.pkl', 'Path to source character vocabulary')
        tf.app.flags.DEFINE_string('target_character_vocabulary', data_original_dir+'en-vi/corp.train.de-en.en.low.character.pkl', 'Path to target character vocabulary')
        tf.app.flags.DEFINE_string('reference_valid_data_e_f', data_original_dir+'en-vi/testing.vi-en.align.from1', 'Path to alignment validation data')
        tf.app.flags.DEFINE_string('reference_valid_data_f_e', data_original_dir+'en-vi/testing.en-vi.align.from1', 'Path to alignment validation data')
    if FLAGS.data == 'en-ja':
        tf.app.flags.DEFINE_string('source_vocabulary', data_original_dir+'en-ja/kyoto-train.low.en.pkl', 'Path to source vocabulary')
        tf.app.flags.DEFINE_string('target_vocabulary', data_original_dir+'en-ja/kyoto-train.low.ja.pkl', 'Path to target vocabulary')
        tf.app.flags.DEFINE_string('source_train_data', data_original_dir+'en-ja/kyoto-train.low.en.lenSent50', 'Path to source training data')
        tf.app.flags.DEFINE_string('target_train_data', data_original_dir+'en-ja/kyoto-train.low.ja.lenSent50', 'Path to target training data')
        tf.app.flags.DEFINE_string('source_valid_data', data_original_dir+'en-ja/testing.en-ja.en', 'Path to source validation data')
        tf.app.flags.DEFINE_string('target_valid_data', data_original_dir+'en-ja/testing.en-ja.ja', 'Path to target validation data')
        tf.app.flags.DEFINE_string('reference_valid_data', data_original_dir+'en-ja/en-ja.align.from1.final', 'Path to alignment validation data')
        tf.app.flags.DEFINE_string('source_character_vocabulary', data_original_dir+'en-ja/corp.train.de-en.de.low.character.pkl', 'Path to source character vocabulary')
        tf.app.flags.DEFINE_string('target_character_vocabulary', data_original_dir+'en-ja/corp.train.de-en.en.low.character.pkl', 'Path to target character vocabulary')
        tf.app.flags.DEFINE_string('reference_valid_data_e_f', data_original_dir+'en-ja/en-ja.align.from1.final', 'Path to alignment validation data')
        tf.app.flags.DEFINE_string('reference_valid_data_f_e', data_original_dir+'en-ja/ja-en.align.from1.final', 'Path to alignment validation data')
    if FLAGS.data == 'ja-en':
        tf.app.flags.DEFINE_string('source_vocabulary', data_original_dir+'en-ja/kyoto-train.low.ja.pkl', 'Path to source vocabulary')
        tf.app.flags.DEFINE_string('target_vocabulary', data_original_dir+'en-ja/kyoto-train.low.en.pkl', 'Path to target vocabulary')
        tf.app.flags.DEFINE_string('source_train_data', data_original_dir+'en-ja/kyoto-train.low.ja.lenSent50', 'Path to source training data')
        tf.app.flags.DEFINE_string('target_train_data', data_original_dir+'en-ja/kyoto-train.low.en.lenSent50', 'Path to target training data')
        tf.app.flags.DEFINE_string('source_valid_data', data_original_dir+'en-ja/testing.en-ja.ja', 'Path to source validation data')
        tf.app.flags.DEFINE_string('target_valid_data', data_original_dir+'en-ja/testing.en-ja.en', 'Path to target validation data')
        tf.app.flags.DEFINE_string('reference_valid_data', data_original_dir+'en-ja/ja-en.align.from1.final', 'Path to alignment validation data')
        tf.app.flags.DEFINE_string('source_character_vocabulary', data_original_dir+'en-ja/corp.train.de-en.de.low.character.pkl', 'Path to source character vocabulary')
        tf.app.flags.DEFINE_string('target_character_vocabulary', data_original_dir+'en-ja/corp.train.de-en.en.low.character.pkl', 'Path to target character vocabulary')
        tf.app.flags.DEFINE_string('reference_valid_data_e_f', data_original_dir+'en-ja/ja-en.align.from1.final', 'Path to alignment validation data')
        tf.app.flags.DEFINE_string('reference_valid_data_f_e', data_original_dir+'en-ja/en-ja.align.from1.final', 'Path to alignment validation data')
    ...
    if FLAGS.data == 'en-fr-jointVoc':
        tf.app.flags.DEFINE_string('source_train_data', data_original_dir+'en-fr/europarl-v7.en-fr.cln.low.en.lenSent50.bpe.32000Joint', 'Path to source training data')
        tf.app.flags.DEFINE_string('target_train_data', data_original_dir+'en-fr/europarl-v7.en-fr.cln.low.fr.lenSent50.bpe.32000Joint', 'Path to target training data')
        tf.app.flags.DEFINE_string('source_valid_data', data_original_dir+'en-fr/testing.low.en.bpe.32000Joint', 'Path to source validation data')
        tf.app.flags.DEFINE_string('target_valid_data', data_original_dir+'en-fr/testing.low.fr.bpe.32000Joint', 'Path to target validation data')
        tf.app.flags.DEFINE_string('reference_valid_data', data_original_dir+'en-fr/testing.en-fr.align', 'Path to alignment validation data')
        tf.app.flags.DEFINE_string('source_idx_data', data_original_dir+'en-fr/testing.low.en.bpe.idx.32000Joint', 'Path to source BPE idx')
        tf.app.flags.DEFINE_string('target_idx_data', data_original_dir+'en-fr/testing.low.fr.bpe.idx.32000Joint', 'Path to target BPE idx')
        tf.app.flags.DEFINE_string('reference_valid_data_f_e', data_original_dir+'en-fr/testing.en-fr.align', 'Path to alignment validation data')
        tf.app.flags.DEFINE_string('reference_valid_data_e_f', data_original_dir+'en-fr/testing.fr-en.align', 'Path to alignment validation data')
    if FLAGS.data == 'fr-en-jointVoc':
        tf.app.flags.DEFINE_string('source_train_data', data_original_dir+'en-fr/europarl-v7.en-fr.cln.low.fr.lenSent50.bpe.32000Joint', 'Path to source training data')
        tf.app.flags.DEFINE_string('target_train_data', data_original_dir+'en-fr/europarl-v7.en-fr.cln.low.en.lenSent50.bpe.32000Joint', 'Path to target training data')
        tf.app.flags.DEFINE_string('source_valid_data', data_original_dir+'en-fr/testing.low.fr.bpe.32000Joint', 'Path to source validation data')
        tf.app.flags.DEFINE_string('target_valid_data', data_original_dir+'en-fr/testing.low.en.bpe.32000Joint', 'Path to target validation data')
        tf.app.flags.DEFINE_string('reference_valid_data', data_original_dir+'en-fr/testing.fr-en.align', 'Path to alignment validation data')
        tf.app.flags.DEFINE_string('source_idx_data', data_original_dir+'en-fr/testing.low.fr.bpe.idx.32000Joint', 'Path to source BPE idx')
        tf.app.flags.DEFINE_string('target_idx_data', data_original_dir+'en-fr/testing.low.en.bpe.idx.32000Joint', 'Path to target BPE idx')
        tf.app.flags.DEFINE_string('reference_valid_data_e_f', data_original_dir+'en-fr/testing.en-fr.align', 'Path to alignment validation data')
        tf.app.flags.DEFINE_string('reference_valid_data_f_e', data_original_dir+'en-fr/testing.fr-en.align', 'Path to alignment validation data')
    
    if FLAGS.data == 'en-ro-jointVoc':
        tf.app.flags.DEFINE_string('source_train_data', data_original_dir+'en-ro/train.merg.en-ro.cln.en.utf8.low.lenSent50.bpe.32000Joint', 'Path to source training data')
        tf.app.flags.DEFINE_string('target_train_data', data_original_dir+'en-ro/train.merg.en-ro.cln.ro.utf8.low.lenSent50.bpe.32000Joint', 'Path to target training data')
        tf.app.flags.DEFINE_string('source_valid_data', data_original_dir+'en-ro/corp.test.ro-en.cln.en.low.bpe.32000Joint', 'Path to source validation data')
        tf.app.flags.DEFINE_string('target_valid_data', data_original_dir+'en-ro/corp.test.ro-en.cln.ro.low.bpe.32000Joint', 'Path to target validation data')
        tf.app.flags.DEFINE_string('reference_valid_data', data_original_dir+'en-ro/test.en-ro.ali.startFrom1', 'Path to alignment validation data')
        tf.app.flags.DEFINE_string('source_idx_data', data_original_dir+'en-ro/corp.test.ro-en.cln.en.low.bpe.idx.32000Joint', 'Path to source BPE idx')
        tf.app.flags.DEFINE_string('target_idx_data', data_original_dir+'en-ro/corp.test.ro-en.cln.ro.low.bpe.idx.32000Joint', 'Path to target BPE idx')
        tf.app.flags.DEFINE_string('reference_valid_data_f_e', data_original_dir+'en-ro/test.en-ro.ali.startFrom1', 'Path to alignment validation data')
        tf.app.flags.DEFINE_string('reference_valid_data_e_f', data_original_dir+'en-ro/test.ro-en.ali.startFrom1', 'Path to alignment validation data')
    if FLAGS.data == 'ro-en-jointVoc':
        tf.app.flags.DEFINE_string('source_train_data', data_original_dir+'en-ro/train.merg.en-ro.cln.ro.utf8.low.lenSent50.bpe.32000Joint', 'Path to source training data')
        tf.app.flags.DEFINE_string('target_train_data', data_original_dir+'en-ro/train.merg.en-ro.cln.en.utf8.low.lenSent50.bpe.32000Joint', 'Path to target training data')
        tf.app.flags.DEFINE_string('source_valid_data', data_original_dir+'en-ro/corp.test.ro-en.cln.ro.low.bpe.32000Joint', 'Path to source validation data')
        tf.app.flags.DEFINE_string('target_valid_data', data_original_dir+'en-ro/corp.test.ro-en.cln.en.low.bpe.32000Joint', 'Path to target validation data')
        tf.app.flags.DEFINE_string('reference_valid_data', data_original_dir+'en-ro/test.ro-en.ali.startFrom1', 'Path to alignment validation data')
        tf.app.flags.DEFINE_string('source_idx_data', data_original_dir+'en-ro/corp.test.ro-en.cln.ro.low.bpe.idx.32000Joint', 'Path to source BPE idx')
        tf.app.flags.DEFINE_string('target_idx_data', data_original_dir+'en-ro/corp.test.ro-en.cln.en.low.bpe.idx.32000Joint', 'Path to target BPE idx')
        tf.app.flags.DEFINE_string('reference_valid_data_e_f', data_original_dir+'en-ro/test.en-ro.ali.startFrom1', 'Path to alignment validation data')
        tf.app.flags.DEFINE_string('reference_valid_data_f_e', data_original_dir+'en-ro/test.ro-en.ali.startFrom1', 'Path to alignment validation data')
    ...
    if FLAGS.data == 'en-ro':
        tf.app.flags.DEFINE_string('source_train_data', data_original_dir+'en-ro/train.merg.en-ro.cln.en.utf8.low.lenSent50.bpe', 'Path to source training data')
        tf.app.flags.DEFINE_string('target_train_data', data_original_dir+'en-ro/train.merg.en-ro.cln.ro.utf8.low.lenSent50.bpe', 'Path to target training data')
        tf.app.flags.DEFINE_string('source_test_data', data_original_dir+'en-ro/train.merg.en-ro.cln.en.utf8.low.lenSent50.bpe.dev', 'Path to source training data')
        tf.app.flags.DEFINE_string('target_test_data', data_original_dir+'en-ro/train.merg.en-ro.cln.ro.utf8.low.lenSent50.bpe.dev', 'Path to target training data')
    ...
    if FLAGS.data == 'ro-en':
        ...
        tf.app.flags.DEFINE_string('source_test_data', data_original_dir+'en-ro/train.merg.en-ro.cln.ro.utf8.low.lenSent50.bpe.dev', 'Path to source training data')
        tf.app.flags.DEFINE_string('target_test_data', data_original_dir+'en-ro/train.merg.en-ro.cln.en.utf8.low.lenSent50.bpe.dev', 'Path to target training data')
...
# Pretrained model
if FLAGS.data == 'en-fr':
    tf.app.flags.DEFINE_string('model_parameter_loaded_from_checkpoint_source', '../../pretrained_model/en-fr_hmm_target_character.ckpt-54000' , '')
    tf.app.flags.DEFINE_string('model_parameter_loaded_from_checkpoint_target', '../../pretrained_model/fr-en_hmm_target_character_1.ckpt-39000' , '')
if FLAGS.data == 'fr-en':
    tf.app.flags.DEFINE_string('model_parameter_loaded_from_checkpoint_source', '../../pretrained_model/fr-en_hmm_target_character_1.ckpt-39000' , '')
    tf.app.flags.DEFINE_string('model_parameter_loaded_from_checkpoint_target', '../../pretrained_model/en-fr_hmm_target_character.ckpt-54000' , '')
if FLAGS.data == 'en-ro':
    tf.app.flags.DEFINE_string('model_parameter_loaded_from_checkpoint_source', '../../pretrained_model/en-ro_hmm_target_ctx_character_3.ckpt-21000' , '')
    tf.app.flags.DEFINE_string('model_parameter_loaded_from_checkpoint_target', '../../pretrained_model/ro-en_hmm_target_ctx_character_1.ckpt-9000' , '')
if FLAGS.data == 'ro-en':
    tf.app.flags.DEFINE_string('model_parameter_loaded_from_checkpoint_source', '../../pretrained_model/ro-en_hmm_target_ctx_character_1.ckpt-9000' , '')
    tf.app.flags.DEFINE_string('model_parameter_loaded_from_checkpoint_target', '../../pretrained_model/en-ro_hmm_target_ctx_character_3.ckpt-21000' , '')
if FLAGS.data == 'en-cz':
    tf.app.flags.DEFINE_string('model_parameter_loaded_from_checkpoint_source', '../../pretrained_model/en-cz_hmm_target_ctx_character_3.ckpt-6000' , '')
    tf.app.flags.DEFINE_string('model_parameter_loaded_from_checkpoint_target', '../../pretrained_model/cz-en_hmm_target_ctx_character_2.ckpt-3000' , '')
if FLAGS.data == 'cz-en':
    tf.app.flags.DEFINE_string('model_parameter_loaded_from_checkpoint_source', '../../pretrained_model/cz-en_hmm_target_ctx_character_2.ckpt-3000' , '')
    tf.app.flags.DEFINE_string('model_parameter_loaded_from_checkpoint_target', '../../pretrained_model/en-cz_hmm_target_ctx_character_3.ckpt-6000' , '')
if FLAGS.data == 'en-de':
    tf.app.flags.DEFINE_string('model_parameter_loaded_from_checkpoint_source', '../../pretrained_model/en-de_hmm_target_character.ckpt-57000' , '')
    tf.app.flags.DEFINE_string('model_parameter_loaded_from_checkpoint_target', '../../pretrained_model/de-en_hmm_target_character.ckpt-90000' , '')
if FLAGS.data == 'de-en':
    tf.app.flags.DEFINE_string('model_parameter_loaded_from_checkpoint_source', '../../pretrained_model/de-en_hmm_target_character.ckpt-90000' , '')
    tf.app.flags.DEFINE_string('model_parameter_loaded_from_checkpoint_target', '../../pretrained_model/en-de_hmm_target_character.ckpt-57000' , '')
